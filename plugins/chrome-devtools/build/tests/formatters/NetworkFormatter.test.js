...
describe('NetworkFormatter', () => {
    ...
    describe('toString', () => {
        ...
        it('shows correct status for request with response code in 200', async () => {
            ...
            assert.equal(formatter.toString(), 'reqid=1 GET http://example.com [success - 200]');
        });
        it('shows correct status for request with response code in 100', async () => {
            ...
            assert.equal(formatter.toString(), 'reqid=1 GET http://example.com [failed - 199]');
        });
        it('shows correct status for request with response code above 200', async () => {
            ...
            assert.equal(formatter.toString(), 'reqid=1 GET http://example.com [failed - 300]');
        });
        it('shows correct status for request that failed', async () => {
            ...
            assert.equal(formatter.toString(), 'reqid=1 GET http://example.com [failed - Error in Network]');
        });
